...
//	TalkingMoose
//
//	Created 3.2.2005 by Uli Kusterer.
...
/*
	Like an NSImageView, but repeats its image horizontally. Useful e.g. to have
	an image or pattern in a window that can be resized to be very wide.
*/
